package com.pdfreader.cn.presentation.components.pdf.resource
...
internal class AssetResourceLoader(
    ...
    override fun shouldInterceptRequest(uri: Uri): WebResourceResponse? {
        if (uri.host == ResourceLoader.RESOURCE_DOMAIN && uri.path?.startsWith("${PATH}com/pdfreader/mozilla") == true) {
...
internal class AssetsPathHandler(
    ...
    override fun handle(path: String): WebResourceResponse? {
        ...
        if (error != null) {
            when ("$error") {
                "java.io.FileNotFoundException: com/pdfreader/mozilla/web/wasm/openjpeg.wasm",
                "java.io.FileNotFoundException: com/pdfreader/mozilla/web/wasm/openjpeg_nowasm_fallback.js"
                    -> onError(PdfException("JPEG2000 not found. Please include jp2 module!"))

                "java.io.FileNotFoundException: com/pdfreader/mozilla/web/wasm/qcms_bg.wasm"
