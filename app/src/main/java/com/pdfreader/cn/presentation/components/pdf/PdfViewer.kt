...
package com.pdfreader.cn.presentation.components.pdf
...
import com.pdfreader.cn.presentation.components.pdf.PdfViewer.Companion.defaultHighlightEditorColors
import com.pdfreader.cn.presentation.components.pdf.js.Body
import com.pdfreader.cn.presentation.components.pdf.js.call
import com.pdfreader.cn.presentation.components.pdf.js.callDirectly
import com.pdfreader.cn.presentation.components.pdf.js.invoke
import com.pdfreader.cn.presentation.components.pdf.js.set
import com.pdfreader.cn.presentation.components.pdf.js.setDirectly
import com.pdfreader.cn.presentation.components.pdf.js.toJsHex
import com.pdfreader.cn.presentation.components.pdf.js.toJsRgba
import com.pdfreader.cn.presentation.components.pdf.js.toJsString
import com.pdfreader.cn.presentation.components.pdf.js.with
import com.pdfreader.cn.presentation.components.pdf.model.SideBarTreeItem
import com.pdfreader.cn.presentation.components.pdf.print.PdfPrintAdapter
import com.pdfreader.cn.presentation.components.pdf.resource.AssetResourceLoader
import com.pdfreader.cn.presentation.components.pdf.resource.ContentResourceLoader
import com.pdfreader.cn.presentation.components.pdf.resource.FileResourceLoader
import com.pdfreader.cn.presentation.components.pdf.resource.NetworkResourceHandler
import com.pdfreader.cn.presentation.components.pdf.resource.NetworkResourceLoader
import com.pdfreader.cn.presentation.components.pdf.resource.PdfViewerResourceLoader
import com.pdfreader.cn.presentation.components.pdf.resource.ResourceLoader
import com.pdfreader.cn.presentation.components.pdf.setting.UiSettings
...
class PdfViewer @JvmOverloads constructor(
     ...
     *
     * @see printFile
     * @see com.pdfreader.cn.presentation.components.pdf.print.PdfPrintAdapter
    ...
    companion object {
        internal const val PDF_VIEWER_URL =
            "https://${ResourceLoader.RESOURCE_DOMAIN}${PdfViewerResourceLoader.PATH}com/pdfreader/mozilla/pdfjs/pdf_viewer.html"
         ...
         *
         * @see com.pdfreader.cn.presentation.components.pdf.PdfViewer.highlightEditorColors
         */
