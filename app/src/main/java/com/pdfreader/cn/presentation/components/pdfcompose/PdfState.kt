...
package com.pdfreader.cn.presentation.components.pdfcompose
...
import com.pdfreader.cn.presentation.components.pdf.PdfDocumentProperties
import com.pdfreader.cn.presentation.components.pdf.PdfListener
import com.pdfreader.cn.presentation.components.pdf.PdfUnstableApi
import com.pdfreader.cn.presentation.components.pdf.PdfViewer as PdfViewerView
import com.pdfreader.cn.presentation.components.pdf.WebViewError
 ...
 * @see com.pdfreader.cn.presentation.components.pdfcompose.PdfViewer
 */
@Composable
 ...
 * @param defaultHighlightColor The default color to be used for highlighting text.
 * @see com.pdfreader.cn.presentation.components.pdfcompose.PdfViewer
 * @see com.pdfreader.cn.presentation.components.pdf.PdfViewer
 */
class PdfState(
    source: PdfSource,
    ...
    /**
     * The editor for interacting with the PDF.
     * @see com.pdfreader.cn.presentation.components.pdf.PdfEditor
     */
...
sealed interface PdfLoadingState {
     ...
     * @see com.pdfreader.cn.presentation.components.pdf.PdfException
     */
