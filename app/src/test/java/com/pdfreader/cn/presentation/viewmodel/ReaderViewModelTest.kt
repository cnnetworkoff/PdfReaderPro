package com.pdfreader.cn.presentation.viewmodel
...
import com.pdfreader.cn.presentation.screens.reader.ReaderAction
import com.pdfreader.cn.presentation.screens.reader.ReaderEvent
import com.pdfreader.cn.presentation.screens.reader.ReaderViewModel
import com.pdfreader.cn.presentation.screens.reader.ReadingTheme
import com.pdfreader.cn.presentation.screens.reader.ScrollMode
...
class ReaderViewModelTest {
    ...
    fun `initial state loads preferences`() = runTest {
        val customPrefs = AppPreferences(
            ...
            readerTheme = com.pdfreader.cn.domain.model.ReadingTheme.DARK
        )
